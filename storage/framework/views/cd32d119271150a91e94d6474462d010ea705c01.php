...
<?php
    use App\Models\Utility;
        ...
        // $logo=\App\Models\Utility::get_file({{ asset('uploads/logo/') }});
            ...
            <div class="container-fluid pe-2">
                <a class="navbar-brand" href="#">
                    ...
                    <?php if($mode_setting['cust_darklayout'] && $mode_setting['cust_darklayout'] == 'on' ): ?>
                        <img src="<?php echo e(asset('uploads/logo/masrah-logo.png')); ?>"
                             alt="<?php echo e(config('app.name', 'Ayam_Masrah')); ?>" class="logo">
                    <?php else: ?>
                        <img src="<?php echo e(asset('uploads/logo/masrah-logo.png')); ?>"
                             alt="<?php echo e(config('app.name', 'Ayam_Masrah')); ?>" class="logo">
                    <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\ERP System\resources\views/layouts/auth.blade.php ENDPATH**/ ?>